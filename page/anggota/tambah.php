...
if(isset($_POST['tambah'])) {
	...
	$sql = $conn->query("INSERT INTO tb_anggota VALUES (null, '$npm', '$nama', '$tempat_lahir', '$tgl_lahir', '$jk', '$prodi')") or die(mysqli_error($conn));
	if($sql) {
...
<div class="card-header mb-5">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="npm" name="npm" type="number" placeholder="Masukkan NPM "/>
    </div>
    <div class="form-group">
        <label class="small mb-1" for="nama_anggota">Nama</label>
        <input class="form-control" id="nama_anggota" name="nama_anggota" type="text" placeholder="Masukkan nama lengkap"/>
    </div>
    <div class="form-group">
        <label class="small mb-1" for="tempat_lahir">Tempat Lahir</label>
        <input class="form-control" id="tempat_lahir" name="tempat_lahir" type="text" placeholder="Masukkan tempat lahir"/>
    </div>
    <div class="form-group">
